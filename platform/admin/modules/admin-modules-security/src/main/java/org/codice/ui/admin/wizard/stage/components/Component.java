...
public class Component<T> implements BaseComponent {
    ...
    public void clearAllErrors() {
        ...
        children = children.stream()
                .filter(component -> !(component instanceof ErrorInfoComponent))
    ...
    public boolean containsErrors() {
        ...
        return children != null && children.stream()
                .anyMatch(p -> p instanceof ErrorInfoComponent || p.containsErrors());
    }
    ...
    public Component isDisabled(boolean disabled){
